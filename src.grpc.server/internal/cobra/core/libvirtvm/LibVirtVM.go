...
func (a *LibVirtVM) SetCORE(CORE int){
	...
	if a.CORE > 4 && a.CORE%2 == 0 {
		a.VNUMA = 2
		a.VNUMA_MEMORY = ( a.MEMORY / 2 )
		a.VNUMA_CORE = a.CORE / 2
		a.VNUMA_0_CPU_MIN = 0
		a.VNUMA_0_CPU_MAX = a.CORE / 2 - 1
		a.VNUMA_1_CPU_MIN = a.CORE / 2
		a.VNUMA_1_CPU_MAX = a.CORE - 1
	} else {
		a.VNUMA = 1
	}
...
func (a *LibVirtVM) CreateNetworkConfig() error {
	...
	var networkConfigTpl string = a.Config.NETWORKCONFIGTPL
...
func (a *LibVirtVM) CreateUserData() error {
        ...
        var userDataTpl string = a.Config.USERDATATPLPATH //"user-data.tpl"
...
func (a *LibVirtVM) CreateVMXML() error {
	...
	logs.Log.Info("Init CreateVMXML")
        ...
        var vmTemplateXml string = a.Config.VMTEMPLATE //"vm.template.xml"
...
func LoadConfigVM(core *Model.Core, increment int) (*LibVirtVM, error) {
        ...
        _, err := c.getConf(core.USER_DATA_PATH)
        if err != nil {
